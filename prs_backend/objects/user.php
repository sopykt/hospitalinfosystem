...
class User{
	...
	function read(){
		...
		// select all query
		$query = "SELECT * FROM " . $this->table_name . " u INNER JOIN role r ON r.role=u.role Order by u.role,u.name";
	...
	function create(){
		...
		$query = "INSERT INTO
					" . $this->table_name . "
				SET
					name=:name, email=:email, phone=:phone, gender=:gender, dob=:dob, password=:password, address=:address, role=:role, created=:created, modified=:modified";
	...
	function update(){
		...
		$query = "UPDATE
					" . $this->table_name . "
				SET
					name=:name, email=:email, phone=:phone, gender=:gender, dob=:dob, address=:address, role=:role, modified=:modified
				WHERE
					uid = :id";
