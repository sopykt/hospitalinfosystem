...
class Booking{
	...
	function read($stime,$uid){
		...
		// select all query
		$query = "Select u.uid,d.did,p.pid,b.bid,DATE_FORMAT(b.bookingtime, '%Y-%m-%d')bookingtime,u.name,u.dob,u.gender,u.address,u.phone,p.code,u1.name as dname from booking b 
